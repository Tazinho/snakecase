...
* To suppress conversion after a non-alphanumeric character (except "_"), you can choose parsing option 5
...
* If you want to leave digits as is (not surrounging with a separator), use parsing option 6
