...
However, note equality in this equation is only one criterion and it still doesn't
imply a unique solution on how to translate an initial string argument to snake or camel case. (Note that also `to_xxx(string) = to_xxx(string)` seems desirable).
...
knitr::kable(tibble::tibble(nr = seq_along(cases),
                            ...
                            `As intended?` = c("X, \\*Td\\*", "X, \\*Td\\*", "X, \\*Td\\*",
                                               "X, \\*Td\\*", "", "X, \\*Td\\*",
                                               "", "? would be ok, but maybe sn_ake or s_nake...-> must be s_nake, because of 10", "X, \\*Td\\*",
                                               "X, \\*Td\\* this one is correct, but it implies that 8 has to be translated to s_nake (otherwise the equation above does not hold)", "X, \\*Td\\*",
                                               "", "? the equation holds, but...hm.., better s_na_ke (would be consistent with 8 and 10 and still allow for capital letter stuff below)", "? the equation holds, but better s_na_k_er, to be consistent with changes (8,10,13)",
                                               "X, \\*Td\\* (the equation will also hold for this one, with a change to 14)",
                                               "", "_X", "",
                                               "? should be snake_snak_e_case",
                                               "_ ?", "",
                                               "_ X",
                                               "_ X", "_ ? (maybe c_id)", "_ ?",
                                               "_ ?", "_ ?", "_ ?",
