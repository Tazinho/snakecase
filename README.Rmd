...
```{r, collapse=TRUE, message=FALSE, echo = TRUE}
library(snakecase)
...
To give a meaningful conversion for different cases, we systematically designed meaningful testcases for conversion to snake, small- and big camel case.
