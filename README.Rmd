...
in general) to different cases like snake_case, smallCamel- and BigCamelCase among others.
...
1. Often it seams more practical to use the first solution. Cases like "SCREAMING_SNAKE_CASE" seem to be more
