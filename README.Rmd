...
* Title Case: `"title` - This one is basically the same as "snake" case with `sep_out = " "`, but in addition it is wrapped into `tools::toTitleCase()` and abbreviations are always turned into upper case.
