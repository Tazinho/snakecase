...
**numerals**: If you want to format the alignment of numerals use `numerals` (`middle` (default), `left`, `right` or `asis`). I.e. to leave digits as is (not surrounding with a separator), use:
