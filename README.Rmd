...
For these simple cases also the shortcuts `to_parsed_case()`, `to_snake_case()`, `to_screaming_snake_case()`, `to_small_camel_case()` etc. are provided, which achieve exactly the same as `to_any_case(string, case)`.
