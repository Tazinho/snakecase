...
**numerals**: If you want to format the alignment of numerals use `numerals` (`"middle"` (default), `"left"`, `"right"` or `"asis"`). I.e. to add no extra separators around digits use:
