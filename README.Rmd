...
to_any_case(string, case = "none"). Mention mixed and parsed case.
...
* parsing_options for example with lower upper. Reming on the design philosophy. Remind on usecases that might be implemented when needed
* cosmetics like 
